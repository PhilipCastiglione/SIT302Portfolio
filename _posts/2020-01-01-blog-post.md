...
*Fig 1. `brainstorm.jpg`: brainstorming whiteboard output*
...
*Fig 2. `crazy_eights_1.jpg`: crazy eights paper output 1-4*
...
*Fig 3. `crazy_eights_2.jpg`: crazy eights paper output 5-8*
...
*Fig 4. `vision.png`: vision documentation from confluence*
...
*Fig 5. `initial_implementation.png`: initial implementation documentation from
confluence*

**Outcomes**

TODO assertion and justification of impact
this trimester
future
...
*Fig 6. `art_assets.png`: summary of three art assets required*
...
*Fig 7. `blueprint_relationships.png`: dependency graph*

![measurement_code_plans](assets/images/measurement_code_plans.png)  
*Fig 8. `measurement_code_plans.png`: planned changes and additions to the
measurement system*

![resource_extraction_code_plans](assets/images/resource_extraction_code_plans.png)  
*Fig 9. `resource_extraction_code_plans.png`: planned changes and additions to
the mining system*

![base_building_code_plans](assets/images/base_building_code_plans.png)  
*Fig 10. `base_building_code_plans.png`: planned changes and additions to the
...
*Fig 26. `ecology_ui.png`: ecology user interface (in-game)*

![soil_damage](assets/images/soil_damage.png)  
*Fig 27. `soil_damage.png`: soil damage after mining (in-game)*

![power_unit](assets/images/power_unit.png)  
*Fig 28. `power_unit.png`: power unit building (in-game)*
...
TODO: remove below
### other stuff? like recommendation from squad leader... other bits


refer to rubric and requirements

* timeliness of contributions
outcomes sections? 1 bug found in all the code, easily fixed...
